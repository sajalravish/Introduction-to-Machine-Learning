...
# I looked up "common email spam words" on Google to find these words

def freq_please_feature(text, freq):
    return float(freq['please'])

def freq_improve_feature(text, freq):
    return float(freq['improve'])

def freq_dear_feature(text, freq):
    return float(freq['dear'])

def freq_content_feature(text, freq):
    return float(freq['content'])

def freq_mime_feature(text, freq):
    return float(freq['mime'])
...
def generate_feature_vector(text, freq):
    ...
    feature.append(freq_improve_feature(text, freq))
    feature.append(freq_dear_feature(text, freq))
    feature.append(freq_content_feature(text, freq))
    feature.append(freq_mime_feature(text, freq))
